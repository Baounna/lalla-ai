...
export function Header() {
  ...
  const links = [
    ...
    { href: "/signs", label: lang === "fr" ? "12 signes" : "12 signs" },
    { href: "/types", label: lang === "fr" ? "Types & stades" : "Types & stages" },
    { href: "/quiz", label: t.nav.quiz },
    { href: "/learn", label: t.nav.learn },
    { href: "/glossary", label: lang === "fr" ? "Glossaire" : "Glossary" },
    { href: "/diagnosed", label: lang === "fr" ? "Diagnostiquée ?" : "Just diagnosed?" },
